...
class face_selection_window(QWidget):
    ...
    def map_region(self):
        ...
        np.save(os.path.join(save_directory, "Full_Face_Pixels.npy"), face_pixels)
        print("Saved!", os.path.join(save_directory, "Full_Face_Pixels.npy"))
...
if __name__ == '__main__':
    ...
    """
    nested_session_list = Session_List.neurexin_intermediate_learning
    flat_session_list = Session_List.flatten_nested_list(nested_session_list)
    data_root = r"/media/matthew/External_Harddrive_1/Neurexin_Data"
    ...
    nested_session_list = Session_List.control_intermediate_learning
    flat_session_list = Session_List.flatten_nested_list(nested_session_list)
