...
def run_local_nmf(U, V, atlas, brainmask):
    ...
    min_pixels = 250  # minimum number of pixels in Allen map for it to be considered a brain region
    loc_thresh = 95  # Localization threshold, i.e. percentage of area restricted to be inside the 'Allen boundary'
    r2_thresh = 0.80  # Fraction of variance in the data to capture with LocaNMF #95, 80
    ...
    # Preprocress Data
    print("brainmask", brainmask.dtype)
