...
class lick_threshold_window(QWidget):
    ...
    def __init__(self, session_list, parent=None):
        ...
        self.channel_dictionary = GLM_Utils.create_stimuli_dictionary()
    ...
    def load_all_data(self):
        ...
        for session_index in tqdm(range(number_of_sessions)):
            ...
            # Load Lick Trace
            ai_data = np.load(os.path.join(current_session, "Downsampled_AI_Matrix_Framewise.npy"))
    ...
    def set_lick_threshold(self):
         ...
         # Get Output Path
        file_save_directory = os.path.join(self.session_list[self.current_session_index], "Behaviour", "Lick_Threshold_Downsampled.npy")
