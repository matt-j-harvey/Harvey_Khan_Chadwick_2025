...
from Preprocessing import Position_Mask, Get_Max_Projection, Motion_Correction, Downsample_Existing_Data
...
def run_motion_correction_pipeline(session_list):
    ...
    for session_index in range(number_of_sessions):
        ...
        # Downsample Data
        Downsample_Existing_Data.downsample_session(base_directory, base_directory, output_file_name="Motion_Corrected_Downsampled_Data.hdf5")
