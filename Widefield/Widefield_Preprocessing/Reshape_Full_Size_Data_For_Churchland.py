...
def create_churchland_format_dataset(base_directory, save_directory, early_cutoff, datafile=r"Motion_Corrected_Mask_Data.hdf5"):
    print("Creating Churchland Format Dataset Full Size")
