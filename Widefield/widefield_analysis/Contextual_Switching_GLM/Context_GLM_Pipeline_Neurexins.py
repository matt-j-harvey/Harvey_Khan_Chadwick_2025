...
def run_glm_pipeline(data_directory, session_list, glm_output_directory, start_window, stop_window, regressor_list):
    ...
    for mouse in tqdm(session_list, desc="Mouse"):
        for session in tqdm(mouse, desc="Session"):
            ...
            # Extract Onsets
            Extract_Onsets.extract_stable_onsets_non_opto_session(data_directory, session, glm_output_directory)
...
control_session_list = Session_List.wildtype_switching_sessions
control_data_root = r"C:\Users\matth\Dropbox\Harvey_Khan_Chadwick_2025\Neurexin_Widefield\Controls"
control_output_root = r"C:\Analysis_Output\Neurexin_Context_GLM\Controls"

hom_session_list = Session_List.neurexin_switching_sessions
hom_data_root = r"C:\Users\matth\Dropbox\Harvey_Khan_Chadwick_2025\Neurexin_Widefield\Homs"
hom_output_root = r"C:\Analysis_Output\Neurexin_Context_GLM\Homs"

output_root = r"C:\Analysis_Output\Neurexin_Context_GLM"


# Run Pipeline
#run_glm_pipeline(control_data_root, control_session_list, control_output_root, start_window, stop_window, regressor_list)
run_glm_pipeline(hom_data_root, hom_session_list, hom_output_root, start_window, stop_window, regressor_list)
