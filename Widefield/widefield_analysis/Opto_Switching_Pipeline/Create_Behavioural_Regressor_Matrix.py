...
def create_behaviour_matrix(data_root_directory, base_directory, mvar_output_directory, lick_lag=1.0):
    ...
    face_motion_energy = np.load(os.path.join(data_root_directory, base_directory, "Mousecam_Analysis", "Mean_Face_Motion_Energy.npy"))
    face_motion_energy = scale_continous_regressors(face_motion_energy)
    face_motion_energy = np.expand_dims(face_motion_energy, axis=1)
