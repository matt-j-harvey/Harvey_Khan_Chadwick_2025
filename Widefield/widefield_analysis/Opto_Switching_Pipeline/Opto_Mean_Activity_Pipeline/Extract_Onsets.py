...
def extract_opto_mapping_onsets(data_directory_root, session):
    ...
    return [visual_context_control_onsets, visual_context_light_onsets, odour_context_control_onsets, odour_context_light_onsets]
