...
def fit_full_model(session, glm_output_directory, design_matrix, delta_f_matrix):

    # Load Best Parameters
    #ridge_penalty, design_matrix = load_best_parameters(glm_output_directory, session, design_matrix)
