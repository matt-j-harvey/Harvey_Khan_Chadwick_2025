...
def plot_results(diagonal_projection_group_list, full_projection_group_list):
...
def recurrent_v_diag_pipeline(data_root, mvar_output_root, session_list):
    ...
    return diagonal_projection_group_list, full_projection_group_list
...
# Run Piepline
diagonal_projection_group_list, full_projection_group_list = recurrent_v_diag_pipeline(data_root, mvar_output_root, control_session_list)

# Plot Results
plot_results(diagonal_projection_group_list, full_projection_group_list)
