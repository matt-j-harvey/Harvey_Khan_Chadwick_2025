...
def sort_raster(master_raster, other_raster_list, sorting_window_start, sorting_window_stop):
    ...
    response = master_raster[sorting_window_start:sorting_window_stop]
...
def view_single_psth(tensor, start_window, stop_window, frame_rate, save_directory, condition_name, sorting_window_start, sorting_window_stop):
    ...
    # Sort Rasters
    sig_activity, [mean_activity] = sort_raster(sig_activity, [mean_activity], sorting_window_start, sorting_window_stop)
    ...
    plt.savefig(os.path.join(save_directory, condition_name + ".png"))
    plt.close()
