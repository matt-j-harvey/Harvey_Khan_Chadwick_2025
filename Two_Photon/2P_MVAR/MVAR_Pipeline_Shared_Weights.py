...
def mvar_pipeline(data_root_directory, session_list, mvar_output_directory, start_window, stop_window, frame_rate):
    ...
    for session in tqdm(session_list, position=0, desc="Session:"):
        ...
        Create_Regression_Matricies.create_regression_matricies_shared_recurrent_weights(data_root_directory,
                                                                                         session,
...
mvar_output_root = r"C:\Users\matth\OneDrive - The Francis Crick Institute\Documents\Neurexin_Paper\ALM 2P\2P_MVAR_Results_Shared_Weights"
