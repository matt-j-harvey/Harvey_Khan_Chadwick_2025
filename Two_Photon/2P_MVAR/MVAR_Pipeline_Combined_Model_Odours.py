...
def mvar_pipeline(data_root_directory, session_list, mvar_output_directory, start_window, stop_window, frame_rate):
    ...
    for session in tqdm(session_list, position=0, desc="Session:"):
        ...
        Create_Regression_Matricies.create_combined_regression_maticies_odours(data_root_directory,
                                                                         session,
...
mvar_output_root = r"C:\Users\matth\OneDrive - The Francis Crick Institute\Documents\Neurexin_Paper\ALM 2P\2P_MVAR_Results_Combined_Model_Odours_No_Delta_1S"
mvar_output_root = r"C:\Users\matth\OneDrive - The Francis Crick Institute\Documents\Neurexin_Paper\ALM 2P\2P_MVAR_Results_Combined_Weights_No_Preceeding_Lick_Regressor"
